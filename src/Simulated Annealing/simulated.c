...
void SaAbreArquivoConfiguracao(char* Nome)
{
	...
	{
		printf("\n================================================================================");
		printf("\n [ERRO] Arquivo '%s' nao existe", Nome);
		printf("\n================================================================================\n\n");
		exit(SA_ERRO_IO);
	}
	...
	while(!Sair && !feof(pArq))
	{
		...
		switch(Controle)
		{
			...
			{
				printf("\n================================================================================");
				printf("\n [ERRO] Caracter de controle '%c' nao identificado na linha %d do arquivo '%s'", Controle, Linha, Nome);
				printf("\n================================================================================\n\n");
				exit(SA_ERRO_PARSING_CONFIG);
...
void SaGeraArquivoEntradaParaODBC(char* pSaida, StSaSolucao* pSolucao)
{
	...
	{
		printf("\n================================================================================");
		printf("\n [ERRO] arquivo '%s' não pode ser criado em SaGeraArquivoEntradaParaODBC()", pSaida);
		printf("\n================================================================================\n");
		exit(SA_ERRO_IO);
	}
...
void SaLogResultado(StSaSolucao* pSolucao, char* Nome)
{
	...
	{
		printf("\n================================================================================");
		printf("\n [ERRO] arquivo '%s' não pode ser criado em SaLogResultado()", Nome);
		printf("\n================================================================================\n");
		exit(SA_ERRO_IO);
	}
...
void SaSimulatedAnnealing(void)
{
	...
	switch(Metodo)
	{
		...
		{
			printf("\n================================================================================");
			printf("\n [ERRO] metodo de construcao inicial desconhecido: %d", Metodo);
			printf("\n================================================================================\n");
